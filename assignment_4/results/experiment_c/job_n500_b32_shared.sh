#!/bin/bash
#SBATCH --job-name=exp_c_shared_n500_b32
...
#SBATCH --output=results/experiment_c/run_n500_b32_shared_%j.out
...
srun ./power_gpu --size 500 --blocksize 32 --max_iteration 100 --use_shared 1 --use_unified 0
