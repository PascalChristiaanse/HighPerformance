#!/bin/bash
#SBATCH --job-name=exp_c_unified_n4000_b100
...
#SBATCH --output=results/experiment_c/run_n4000_b100_unified_%j.out
...
srun ./power_gpu --size 4000 --blocksize 100 --max_iteration 100 --use_shared 1 --use_unified 1
