#!/bin/bash
#SBATCH --job-name=exp_c_global_n50_b32
...
#SBATCH --output=results/experiment_c/run_n50_b32_global_%j.out
...
srun ./power_gpu --size 50 --blocksize 32 --max_iteration 100 --use_shared 0 --use_unified 0
