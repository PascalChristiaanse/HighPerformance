#!/bin/bash
#SBATCH --job-name=exp_c_unified_n50_b32
...
#SBATCH --output=results/experiment_c/run_n50_b32_unified_%j.out
...
srun ./power_gpu --size 50 --blocksize 32 --max_iteration 100 --use_shared 1 --use_unified 1
